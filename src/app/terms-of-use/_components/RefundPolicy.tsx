...
const RefundPolicy = () => {
  ...
  return (
    <div className="text-gray-600 space-y-6 text-xs sm:text-sm">
      <p>
        At Sterling stack limited, we strive for 100% accuracy in every order.
      ...
      <section>
        ...
        <ul className="list-disc pl-5 mt-2 space-y-2">
          ...
          <li>
            ...
            our error, sterling stack limited Import covers the return shipping. For all
      ...
      <section>
        ...
        <p>
          At sterling stack limited Import, we act as your dedicated procurement agent. While
