      ...
      <div className="bg-white border border-slate-200 rounded-3xl p-8 space-y-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 text-xs md:text-sm">
          ...
          <p>
            ...
            sterling stack limited bears no responsibility for items signed for
        ...
        <div className="pt-4 flex items-center gap-3 text-xs font-bold text-primary-100">
          Queries:{" "}
          <a
            href="mailto:IgweBlessing@sterling-stack.com.ng"
            className="hover:underline"
          >
            IgweBlessing@sterling-stack.com.ng
          </a>
        </div>
      </div>
