...
const Footer = () => {
  ...
  return (
    <footer className=" w-full bg-[#242629]  py-2 flex flex-col item-center mb-[-100px]">
          ...
          <div className="flex gap-4 w-full pt-3">
            {footerData.map((section, index) => (
              <div key={index} className="flex flex-col gap-4 lg:gap-5 w-full">
                <span className="text-[#fff] font-medium text-base leading-[1.6]">
                  {section.title}
                </span>
                {section.links.map((link, linkIndex) => (
                  <Link
                    ...
                    className="text-[#fff] text-sm leading-[1.3] hover:text-gray-400 transition-[.3]"
                  >
                    {link.label}
                  </Link>
                ))}
      ...
      <div className="mx-auto max-w-[1350px]">
        <div className="flex items-center justify-center py-2">
          <div className="text-[#fff] sm:font-mono text-xs leading-[1.2]">
