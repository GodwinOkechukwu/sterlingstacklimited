...
export const SITE_NAME = "SterlingStack Limited";
export const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL ||
  "http://sterlingstack-limited.com"; // Update with actual URL
export const TWITTER_HANDLE = "contact@sterlingstack.com";
...
export const SEODATA: Record<string, SEOConfig> = {
  default: {
    ...
    description:
      "SterlingStack Limited Ltd provides cutting-edge software development, AI integration, and digital transformation strategies to scale modern enterprises.",
    keywords: [
      "BrightAxis Digital",
  ...
  register: {
    ...
    description:
      "Create an account to start your project journey with SterlingStack Limited and access premium tech resources.",
    keywords: [
